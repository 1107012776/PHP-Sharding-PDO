...
trait SelectSearchSharingTrait
{
    ...
    private function _defaultSearch()
    {
        ...
        if (empty($this->_current_exec_table) && empty($this->_table_name_index)) {  //全部扫描
            $sql = 'select ' . $this->_field_str . ' from ' . $this->getExecStringTableAlias($this->_table_name) . $this->_condition_str . $this->_group_str . $this->_order_str . $this->_limit_str;
        } elseif (empty($this->_current_exec_table) && !empty($this->_table_name_index)) {
            foreach ($this->_table_name_index as $tableName) {
                $sqlArr[] = 'select ' . $this->_field_str . ' from ' . $this->getExecStringTableAlias($tableName) . $this->_condition_str . $this->_group_str . $this->_order_str . $this->_limit_str;
            }
        } else {
            $sql = 'select ' . $this->_field_str . ' from ' . $this->getExecStringTableAlias($this->_current_exec_table) . $this->_condition_str . $this->_group_str . $this->_order_str . $this->_limit_str;
        }
        $statementArr = [];
